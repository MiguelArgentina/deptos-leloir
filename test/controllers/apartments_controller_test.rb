...
class ApartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create apartment" do
    assert_difference("Apartment.count") do
      post apartments_url, params: { apartment: { description: @apartment.description, location: @apartment.location, title: @apartment.title } }
    end
  ...
  test "should update apartment" do
    patch apartment_url(@apartment), params: { apartment: { description: @apartment.description, location: @apartment.location, title: @apartment.title } }
